...
clock_h = {
    ...
    graph_fg_colour=destaque,      graph_fg_alpha=0.3,
    txt_radius=34,
...
clock_s = {
    ...
    graph_bg_colour=0xffffff,      graph_bg_alpha=0.0,
    graph_fg_colour=0xFFFFFC,      graph_fg_alpha=0.2,
    txt_radius=40,
...
gauge = {
{
    ...
    hand_fg_colour=destaque,       hand_fg_alpha=1.0,
    txt_radius=40,
    txt_weight=0,                  txt_size=10.0,
    txt_fg_colour=destaque,        txt_fg_alpha=1.0,
